...
export function TypeNumber({ filterItem, applyingFilter }: TypeProps) {
    const { id, condition, conditionFixed = false, value } = filterItem
    ...
    function validationArrayNumber(): boolean {
        let isInvalido = true
        ...
        <div className="bg-base-100 absolute h-50 w-60 rounded-b-md z-10 shadow-md shadow-base-300"> 
            <div className="flex  rounded-s-md flex-col justify-end items-end p-2">
                <div className="w-full mt-4">
                    ...
                    <button
                        disabled={validationArrayNumber()}
